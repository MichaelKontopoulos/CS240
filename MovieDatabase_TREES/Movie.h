 ...
 */
 ...
 int add_new_movie(unsigned int movieID, int category, int year,movie_t **root);
 ...
 *         1 on failure
 */
  void sort_categories(int category,int year,int movieID,int watchedCounter,int sumScore,float medianScore,movie_t **root);
 ...
 */
 ...
 int search_movie(unsigned int movieID, int category,movie_t **root);
